...
14. 텔레그램은 정상 발행·정상 검증 시 보고하지 않는다. 빌드·배포·라이브 URL·이미지·메타·이메일 검증 중 하나라도 실패하여 사용자 조치가 필요한 경우에만 한국어로 원인·영향·검증 URL/로그 요약을 간결하게 보고한다. 내부 후보군·점수표·선정 과정은 어떤 경우에도 보고하지 않는다.
